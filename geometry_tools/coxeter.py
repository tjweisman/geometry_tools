...
class CoxeterGroup:
    ...
    def geometric_representation(self):
        ...
        """
        return self.cartan_representation(2 * self.bilinear_form)
    ...
    def canonical_representation(self):
        ...
        """
        return self.geometric_representation().compose(
    ...
    def tits_vinberg_rep(self, parameters, diagonalize=False):
        ...
        diagonalize : bool
            ...
            a diagonal symmetric bilinear form with unit eigenvalues.
        ...
        cartan_rep = self.cartan_representation(cartan)

        if not diagonalize:
            return cartan_rep

        #TODO: check if Cartan matrix is symmetric for this step
        W = utils.diagonalize_form(cartan / 2, order_eigenvalues="minkowski")

        return cartan_rep.compose(
    ...
    def diagonal_rep(self, order_eigenvalues="signed"):
        ...
        by geometric_representation so that in the standard basis on
        ...
        rep = self.geometric_representation()
    ...
    def hyperbolic_rep(self):
        ...
        """
        matrix_rep = self.diagonal_rep(order_eigenvalues="minkowski")
